        ...
        <main>
            <div className="service-presentation">
                <div className="service-presentation__text">
                    <h1 className="service-presentation__title">10,000+ of our users love our products.</h1>
                    <p className="service-presentation__content">We only provide great products combined with 
            ...
            <div className="service-reviews">
                ...
                <div className="reviewer">
                    <div className="reviewer__profile">
                        <img className="reviewer__profile-image" src={irene} alt="" />
